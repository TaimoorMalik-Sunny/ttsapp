...
export default function Login() {
  ...
  const handleAdminLogin = async (e: React.FormEvent) => {
    ...
    // This would typically involve calling your own API endpoint
                ...
                <form onSubmit={handleAdminLogin} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setAdminCredentials({...adminCredentials, otp: e.target.value})}
                      required
                      placeholder="Enter OTP sent to registered number"
                    />
                  </div>
